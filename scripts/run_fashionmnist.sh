#!/bin/bash
# run_fashionmnist_experiments.sh — Run all experiments for FashionMNIST.
#
# Usage:
#   chmod +x run_fashionmnist_experiments.sh
#   ./run_fashionmnist_experiments.sh
...
echo "  FashionMNIST Experiment Suite" | tee -a "$SUMMARY_LOG"
...
run_experiment() {
    ...
    shift
    local cmd="python pipeline.py --dataset FashionMNIST $@"
...
run_experiment "fm_g1_geiping_fc1_r0.10" --poison_rate 0.10 --no_plots
run_experiment "fm_g1_geiping_fc1_r0.15" --poison_rate 0.15 --no_plots
run_experiment "fm_g1_geiping_fc1_r0.33" --poison_rate 0.33 --no_plots
...
run_experiment "fm_g2_badnets_fc1_r0.10" --poison_rate 0.10 --reconstruction_method badnets --no_plots
run_experiment "fm_g2_badnets_fc1_r0.15" --poison_rate 0.15 --reconstruction_method badnets --no_plots
run_experiment "fm_g2_badnets_fc1_r0.33" --poison_rate 0.33 --reconstruction_method badnets --no_plots
...
echo "" | tee -a "$SUMMARY_LOG"
echo "============================================================" | tee -a "$SUMMARY_LOG"
echo "  All FashionMNIST experiments complete" | tee -a "$SUMMARY_LOG"
