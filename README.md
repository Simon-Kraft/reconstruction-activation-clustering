...
├── data_raw/               # Real, downloaded torchvision datasets (auto-created)
└── outputs/                # Everything generated by experiments (auto-created)
    ├── <exp_id>/            # One folder per pipeline.py run
    ...
    └── suites/              # Aggregate logs/plots spanning many runs
        ...
        ├── fashionmnist/     # run_fashionmnist.sh output
        └── noise_ablation/   # run_noise_ablation.sh output
```
